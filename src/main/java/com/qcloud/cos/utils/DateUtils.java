...
public class DateUtils {
    ...
    /* protected static final DateTimeFormatter rfc822DateFormat = DateTimeFormat
            ...
            .withZone(GMT);*/
    protected static final DateTimeFormatter rfc822DateFormat = DateTimeFormatter
            .ofPattern("EEE, dd MMM yyyy HH:mm:ss 'GMT'")
            .withLocale(Locale.US)
            .withZone(GMT);

    /** ISO 8601 format */
    /* protected static final DateTimeFormatter iso8601DateFormat = ISODateTimeFormat.dateTime()
            .withZone(GMT);*/
    protected static final DateTimeFormatter iso8601DateFormat = DateTimeFormatter.ISO_INSTANT.withZone(GMT);

    /** Alternate ISO 8601 format without fractional seconds */
    /* protected static final DateTimeFormatter alternateIso8601DateFormat = DateTimeFormat
            .forPattern("yyyy-MM-dd'T'HH:mm:ss'Z'")
            .withZone(GMT);*/
    protected static final DateTimeFormatter alternateIso8601DateFormat = DateTimeFormatter
    ...
    public static String formatRFC822Date(Date date) {
        ...
        return rfc822DateFormat.format(date.toInstant());
    }
    ...
    public static Date parseRFC822Date(String dateString) {
        return Date.from(Instant.from(rfc822DateFormat.parse(dateString)));
    ...
    public static String formatISO8601Date(Date date) {
        return iso8601DateFormat.format(date.toInstant());
    }
    ...
    public static Date parseISO8601Date(String dateString) {
        ...
        try {
            if (temp.equals(dateString)) {
                ...
                return Date.from(Instant.from(iso8601DateFormat.parse(dateString)));
            }
            // Handling edge case:
            ...
            final long milliLess365Days = Instant.from(iso8601DateFormat.parse(temp))
                    .toEpochMilli();
            ...
            try {
                ...
                return Date.from(Instant.from(alternateIso8601DateFormat.parse(dateString)));
    ...
    /**
     * Returns a date string with the prefix temporarily substituted, if applicable, so that JodaTime can handle it.
     * Otherwise, if not applicable, the original date string is returned.
     */
    private static String tempDateStringForJodaTime(String dateString) {
        ...
        return dateString.startsWith(fromPrefix) ? toPrefix + dateString.substring(fromPrefix.length()) : dateString;
    }
}
