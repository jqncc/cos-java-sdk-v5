...
public class StringUtils {
    ...
    /**
     * A null-safe trim method. If the input string is null, returns null; otherwise returns a trimmed version of the
     * input.
     */
     ...
     * @return A new string created from the specified string, minus any surrounding quotes.
     */
    ...
    /**
     * Returns a new string created by joining each of the strings in the specified list together, with a comma between
     * them.
     *
     * @param strings The list of strings to join into a single, comma delimited string list.
     * @return A new string created by joining each of the strings in the specified list together, with a comma between
     *         strings.
     */
